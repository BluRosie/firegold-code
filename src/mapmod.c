...
void doBW_map(unsigned char type, unsigned int thingy, unsigned int thingy2, unsigned int offset, unsigned int length)
{
...
void filter_map(unsigned int palette, unsigned int dest, unsigned int mode)
{
	int type = dest;
